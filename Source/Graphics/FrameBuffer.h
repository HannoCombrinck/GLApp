...
namespace baselib 
{
	namespace graphics
	{
		...
		public:
			...
			static std::shared_ptr<FrameBuffer> create(const std::vector<std::shared_ptr<Texture>>& aspColourTargets, const std::shared_ptr<Texture>& spDepthTarget);
			//! Creates and returns an empty frame buffer object. 
			static std::shared_ptr<FrameBuffer> createEmpty();
			...
			void bind(const std::shared_ptr<Texture>& spColourTarget);
		...
		protected:
			...
			FrameBuffer(unsigned int uID, int iNumTargets, const std::vector<std::shared_ptr<Texture>>& aspColourTargets, const std::shared_ptr<Texture>& spDepthTarget);
		...
		private:
			...
			std::vector<std::shared_ptr<Texture>> m_aspColourTargets; //!< List of colour target textures.
			std::shared_ptr<Texture> m_spDepthTarget; //!< Depth texture.
